module moduleBasis
    ...
    # -------------------------------------------------------------
    # Classic functions--------------------------------------------
    function getShapeValue_Classic(thisMaterialPoint::moduleMaterialPoint.mpmMaterialPoint_2D_Classic, 
                                   thisGridPoint::moduleGrid.mpmGridPoint, 
                                   thisGrid::moduleGrid.mpmGrid)
        fShapeValue = 0.0
    ...
    function getShapeGradient_Classic(thisMaterialPoint::moduleMaterialPoint.mpmMaterialPoint_2D_Classic, 
                                      thisGridPoint::moduleGrid.mpmGridPoint, 
                                      thisGrid::moduleGrid.mpmGrid)
        v2Result = zeros(2)
    ...
    function getShapeAndGradient_Classic(thisMaterialPoint::moduleMaterialPoint.mpmMaterialPoint_2D_Classic, 
                                         thisGridPoint::moduleGrid.mpmGridPoint, 
                                         thisGrid::moduleGrid.mpmGrid)
        v2Result = zeros(2)
